void RegisterAllStrippedInternalCalls()
{
	...
	//Start Registrations for type : UnityEngine.ParticleSystem/EmissionModule
		...
		void Register_UnityEngine_ParticleSystem_EmissionModule_set_rateOverDistance_Injected();
		Register_UnityEngine_ParticleSystem_EmissionModule_set_rateOverDistance_Injected();
	...
	//Start Registrations for type : UnityEngine.ParticleSystem/NoiseModule
		...
		void Register_UnityEngine_ParticleSystem_NoiseModule_set_frequency_Injected();
		Register_UnityEngine_ParticleSystem_NoiseModule_set_frequency_Injected();
		...
		void Register_UnityEngine_ParticleSystem_NoiseModule_set_octaveCount_Injected();
		Register_UnityEngine_ParticleSystem_NoiseModule_set_octaveCount_Injected();
		...
		void Register_UnityEngine_ParticleSystem_NoiseModule_set_strengthX_Injected();
		Register_UnityEngine_ParticleSystem_NoiseModule_set_strengthX_Injected();
		...
		void Register_UnityEngine_ParticleSystem_NoiseModule_set_strengthY_Injected();
		Register_UnityEngine_ParticleSystem_NoiseModule_set_strengthY_Injected();
		...
		void Register_UnityEngine_ParticleSystem_NoiseModule_set_strengthZ_Injected();
		Register_UnityEngine_ParticleSystem_NoiseModule_set_strengthZ_Injected();
